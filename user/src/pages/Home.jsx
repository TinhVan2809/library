  ...
  useEffect(() => {
    ...
    const fetchLiveSearch = async () => {
      ...
      try {
        ...
        const response = await fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getBooks&page=1&limit=7&search=${encodeURIComponent(debouncedSearchTerm)}`);
  ...
  useEffect(() => {
    ...
    const fetchBooks = async () => {
      ...
      try {
        ...
        // "live search".
        let booksApiUrl = `http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getBooks&page=${currentPage}&limit=${booksPerPage}`;
        ...
        const [booksRes, authorsRes, categoriesRes, publishersRes, mostbookloanRes, seriesRes, lowStockBooksRes, booksallRes, favortiesRes, bookloanSildeRes] = await Promise.all([ // Cập nhật API để hỗ trợ phân trang
          fetch(booksApiUrl),
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForAuthors.php?action=GetAuthors'), //Lấy tác giả
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForCategories.php?action=getCategory'), // Lấy thể loại
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForPublishers.php?action=GetPublishers'), // Lấy nhà xuất bản
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBookLoans.php?action=getMostBookLoanForSlideShow'), 
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getSeriesWithBooks'), // Fetch dữ liệu bộ sách (series)
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getLowStockBooks'),  // lấy số lượng sách còn ít 
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getAllBooks'), // Lấy tất cả sách để chạy slide liên tục
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForFavorites.php?action=getTopFavoritedBooks'), // Lấy sách yêu thích nhất
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBookloans.php?action=getBookLoanNearly')// Lấy sách được mượn gần đây
        ]);
