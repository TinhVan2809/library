...
function BookDetail() {
    ...
    const fetchReviews = async (currentBookId) => {
        try {
            const reviewResponse = await fetch(`https://libraryuni.free.nf/library/Library/Connection/actions/actionForReview.php?action=getReviewsByBookId&BooksID=${currentBookId}`);
    ...
    useEffect(() => {
        ...
        const fetchBookAndRelated = async () => {
            ...
            try {
                const response = await fetch(`https://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getBookById&BooksID=${bookId}`); 
                if (!response.ok) {
                ...
                if (!result || result.success === false || !result.data) {
                    ...
                    if (mainBookData.CategoryID) {
                        const relatedResponse = await fetch(`https://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getBooks&categoryId=${mainBookData.CategoryID}`);
                    ...
                    if (mainBookData.AuthorID) {
                        const authorBooksResponse = await fetch(`https://libraryuni.free.nf/library/Library/Connection/actions/actionForAuthors.php?action=getBooksByAuthor&AuthorID=${mainBookData.AuthorID}&currentBookID=${bookId}`);
                    ...
                    if (mainBookData.SeriesID) {
                        const seriesBooksResponse = await fetch(`https://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getBooksBySeriesId&SeriesID=${mainBookData.SeriesID}&currentBookID=${bookId}`);
                    ...
                    const favoriteStatusUrl = `https://libraryuni.free.nf/library/Library/Connection/actions/actionForFavorites.php?action=getFavoriteStatus&BooksID=${bookId}${user ? `&StudentID=${user.StudentID}` : ''}`;
        ...
        fetchBookAndRelated();
    }, [bookId, user]); // Chạy lại effect khi bookId thay đổi
    ...
    const confirmBorrowRequest = async () => {
        ...
        try {
            const response = await fetch('https://libraryuni.free.nf/library/Library/Connection/actions/actionForBookLoanRQ.php?action=addBookLoanRequest', {
                method: 'POST',
                body: postData, 
            });
            const result = await response.json();
    ...
    const handleAddToList = async () => {
        ...
        try {
            const response = await fetch('https://libraryuni.free.nf/library/Library/Connection/actions/actionForMyList.php?action=addToList', {
                method: 'POST',
                body: postData,
            });
            const result = await response.json();
    ...
    const handleToggleFavorite = async () => {
        ...
        try {
            const response = await fetch('https://libraryuni.free.nf/library/Library/Connection/actions/actionForFavorites.php?action=toggleFavorite', {
                method: 'POST',
                body: postData,
            });
    ...
    const handleSubmitReview = async (event) => {
        ...
        try {
            const response = await fetch('https://libraryuni.free.nf/library/Library/Connection/actions/actionForReview.php?action=addReview', {
                method: 'POST',
                body: postData,
            });
