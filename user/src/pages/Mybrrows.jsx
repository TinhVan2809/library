...
function MyBrrows() {
            ...
            const fetchAllData = async () => {
                ...
                try {
                    const [borrowedRes, requestedRes] = await Promise.all([
                        ...
                        fetch(`https://libraryuni.free.nf/library/Library/Connection/actions/actionForBookLoanRQ.php?action=getBookLoanRQByStudent&StudentID=${user.StudentID}`)
                    ]);
    ...
    const handleCancelRequest = async (requestID) => {
        ...
        try {
            const response = await fetch('https://libraryuni.free.nf/library/Library/Connection/actions/actionForBookLoanRQ.php?action=cancelBookLoanRequest', {
                method: 'POST',
                body: postData,
            });
