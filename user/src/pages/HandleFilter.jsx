    ...
    const fetchBooks = async () => {
      ...
      try {
        ...
        const [booksRes, categoriesRes, publishersRes, booksallRes, favortiesRes] = await Promise.all([ // Cập nhật API để hỗ trợ phân trang
          ...
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getAllBooks'),
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForFavorites.php?action=getTopFavoritedBooks')
        ]);
