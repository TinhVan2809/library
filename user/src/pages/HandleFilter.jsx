    ...
    const fetchBooks = async () => {
      ...
      try {
        ...
        const [booksRes, categoriesRes, publishersRes, booksallRes, favortiesRes] = await Promise.all([ // Cập nhật API để hỗ trợ phân trang
          fetch(booksApiUrl),
          fetch('https://libraryuni.free.nf/library/Library/Connection/actions/actionForCategories.php?action=getCategory'),
          fetch('https://libraryuni.free.nf/library/Library/Connection/actions/actionForPublishers.php?action=GetPublishers'),
          fetch('https://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getAllBooks'),
          fetch('https://libraryuni.free.nf/library/Library/Connection/actions/actionForFavorites.php?action=getTopFavoritedBooks')
        ]);
