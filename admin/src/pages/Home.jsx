...
function CategoryList() {
  ...
  useEffect(() => {
    const fetchCategory = async () => {
      try {
        const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForCategories.php?action=getCategory');
        if (!response.ok) {
...
function PublishersList() {
  ...
  useEffect(() => {
    const fetchPublishers = async () => {
      ...
      try {
        const rp = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForPublishers.php?action=GetPublishers');
