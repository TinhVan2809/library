...
function HandlePublishers() {
        ...
        const fetchPublisherData = async () => {
            try{
                const [publisherRes, countPublisherRes] = await Promise.all([
                    ...
                    fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForPublishers.php?action=getCountPublishers'),
    ...
    const handleAddNewPublisher = async (e) => {
        ...
        try {
            ...
            const res = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForPublishers.php', {
                method: 'POST',
