...
function StudentList() {
  ...
  const fetchData = async () => {
    try {
      ...
      const [studentsRes, majorsRes, facultiesRes] = await Promise.all([
        fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForStudent.php?action=GetStudent'),
        fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForMajor.php?action=getMajors'),
        fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForFaculty.php?action=getFaculties')
      ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForStudent.php?action=${action}`, {
        method: 'POST',
        body: postData,
      });
  ...
  const handleGetStudentById = async (studentId) => {
    ...
    try { // Sửa lỗi chính tả: getStudentyById -> getStudentById
      const response = await fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForStudent.php?action=getStudentById&StudentID=${studentId}`);
      const result = await response.json();
  ...
  const handleDeleteStudent = async (studentId) => {
    ...
    try {
      const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForStudent.php?action=DeleteStudent', {
        method: 'POST',
        body: postData,
      });
      const result = await response.json();
...
function MajorManager() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForMajor.php?action=${action}`, {
  ...
  const handleDelete = async (majorId) => {
    ...
    try {
      const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForMajor.php?action=deleteMajor', {
        method: 'POST', body: postData,
      });
      const result = await response.json();
      alert(result.message);
  ...
  const handleGetMajorById = async (majorId) => {
    ...
    try {
      const response = await fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForMajor.php?action=getMajorById&MajorID=${majorId}`);
      const result = await response.json();
...
function FacultyManager() {
  ...
  const fetchFaculties = async () => {
    try {
      setLoading(true);
      const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForFaculty.php?action=getFaculties');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForFaculty.php?action=${action}`, {
        method: 'POST',
        body: postData,
      });
      const result = await response.json();
  ...
  const handleGetFacultyById = async (facultyId) => {
    ...
    try {
      const response = await fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForFaculty.php?action=getFacultyById&FacultyID=${facultyId}`);
      const result = await response.json();
  ...
  const handleDelete = async (facultyId) => {
    ...
    try {
      const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForFaculty.php?action=deleteFaculty', {
        method: 'POST',
        body: postData,
      });
      const result = await response.json();
