...
function AddBookForm({ onBookAdded }) {
  ...
  useEffect(() => {
    const loadAllData = async () => {
      setLoading(true);
      await Promise.all([
        fetchData('http://libraryuni.free.nf/library/Library/Connection/actions/actionForAuthors.php?action=GetAuthors', setAuthors),
        fetchData('http://libraryuni.free.nf/library/Library/Connection/actions/actionForCategories.php?action=getCategory', setCategories),
        fetchData('http://libraryuni.free.nf/library/Library/Connection/actions/actionForPublishers.php?action=GetPublishers', setPublishers),
        fetchData('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getAllSeries', setBookSeries), // Lấy danh sách bộ sách
      ]);
      setLoading(false);
    };
    loadAllData();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=AddBook', {
        method: 'POST',
        body: postData,
...
function GetBooks({ refreshKey }) {
  ...
  const SERVER_BASE = 'http://libraryuni.free.nf/library/Library/'; // chỉnh nếu cần
    ...
    const fetchBooks = async () => {
      ...
      try {
        const [booksRes, authorsRes, categoriesRes, publishersRes, bookSeriesRes] = await Promise.all([
          ...
          fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getBooks&page=${currentPage}`),
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForAuthors.php?action=GetAuthors'),
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForCategories.php?action=getCategory'),
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForPublishers.php?action=GetPublishers'),
          fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getAllSeries'),
        ]);
  ...
  const handleGetBookById = async (bookId) => {
    try {
      setEditingBook(null);
      const response = await fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getBookById&BooksID=${bookId}`);
      const result = await response.json();
  ...
  const handleDeleteBookById = async (BooksID) => {
    ...
    try {
      ...
      const res = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php', {
        method: 'POST',
...
// update sách
  ...
  const handleUpdateBookSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=UpdateBook', {
        method: 'POST',
        body: postData,
      });
