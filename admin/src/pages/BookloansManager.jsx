...
function BookLoanList({ onBookAdded, onCancel }) { // eslint-disable-line
  ...
  const fetchData = async () => {
    try {
      ...
      const [bookLoansRes, studentsRes, booksRes] = await Promise.all([
        fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForBookLoans.php?action=GetBookLoans&page=${currentPage}`),
        ...
        fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBooks.php?action=getBooks')
      ]);
 ...
 // Hàm xử lý khi nhấn nút "Xóa"
  const handleDeleteBookLoan = async (bookloanId) => {
    ...
    try {
      const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBookLoans.php?action=DeleteBookLoan', {
        method: 'POST',
        body: postData,
      });
...
function BookLoanForm({ students = [], books = [], onAdded }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const resp = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBookLoans.php?action=AddBookLoan', {
        method: 'POST',
        body: postData,
      });
...
function BookLoanRequestList() {
    ...
    const handleUpdateRequestStatus = async (requestID, newStatus) => {
      ...
      try {
        const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/actionForBookLoanRQ.php?action=updateRequestStatus', {
          method: 'POST',
          body: postData,
        });
    ...
    const fetchBookLoanRQ = async () => {
      try {
        ...
        const response = await fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/actionForBookLoanRQ.php?action=getAllBookLoanRQ&page=${rqCurrentPage}`);
        if (!response.ok) {
