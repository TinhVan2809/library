...
function AddAdminForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/action.php?action=AddAdmin', {
        method: 'POST',
        body: postData,
      });
...
function GetAdmin() {
  ...
  const handleGetAdminById = async (AdminID) => {
    try {
      const response = await fetch(`http://libraryuni.free.nf/library/Library/Connection/actions/action.php?action=getAdminById&AdminID=${AdminID}`);
      if (!response.ok) {
        throw new Error(`Lỗi HTTP! Trạng thái: ${response.status}`);
      }
      const result = await response.json();
  ...
  const handleDelete = async (adminId) => {
    ...
    try {
      const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/action.php?action=DeleteAdmin', {
        method: 'POST',
        body: postData,
      });
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/action.php?action=UpdateAdmin', {
        method: 'POST',
        body: postData,
      });
  ...
  useEffect(() => {
    const fetchAdmins = async () => {
      try {
        ...
        const response = await fetch('http://libraryuni.free.nf/library/Library/Connection/actions/action.php?action=getAdmins');
        if (!response.ok) {
          throw new Error(`Lỗi HTTP! Trạng thái: ${response.status}`);
        }
